## efctl env assembly deploy turret

Deploy a Smart Turret

```
efctl env assembly deploy turret [flags]
```

### Options

```
  -h, --help   help for turret
```
...
* [efctl env assembly deploy](efctl_env_assembly_deploy.md)	 - Deploy a new assembly
