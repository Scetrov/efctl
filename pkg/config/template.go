...
const RecommendedWorldContractsRef = "v0.0.31"
...
# Ref (branch, tag, or commit) to checkout for world-contracts (default: %s)
...
# Ref (branch, tag, or commit) to checkout for builder-scaffold (default: %s)
